<x-app-layout>
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Add Exam</h1>
            <p class="text-gray-600 mt-1">Create a new exam to receive AI-powered study schedules.</p>
        </div>
            ...
            <form action="{{ route('exams.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-text-input id="exam_date" type="date" name="exam_date" required class="block w-full mt-2 border-gray-300 rounded-xl shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="score" type="number" step="0.1" name="score" class="block w-full mt-2 border-gray-300 rounded-xl shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Optional" />
                    </div>
                </div>
                <div>
                    <x-input-label for="topics" value="Topics Covered (Optional)" class="text-sm font-semibold text-gray-700" />
                    <textarea id="topics" name="topics" rows="3" class="block w-full mt-2 rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g. Chapters 1-5, Thermodynamics, etc."></textarea>
                </div>
